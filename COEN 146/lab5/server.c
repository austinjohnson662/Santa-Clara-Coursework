...
//Date: 11/2/2020
//Title: Lab5 - server
//Description: This program is meant to receive a file from a client program. The program takes the file and copies into the specified file.
//This program utilizes TFv2 to ensure reliable delivery
...
int main(int argc, char *argv[]) {
	...
	//******STUDENT WORK******
		write(fd, packet.data, packet.header.len);
		seqnum = !seqnum;
