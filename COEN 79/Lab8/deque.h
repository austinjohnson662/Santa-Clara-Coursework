...
namespace coen79_lab8
{
    ...
    void deque<Item>::push_front(const value_type& entry)
    {
        ...
        if (first_bp == NULL)
        {
            ...
            //creates a new block and re assigns all appropriate values. Sets entry in the new array
            // STUDENT WORK...
        ...
        {
            //decrement front ptr, then set entry to it
            // STUDENT WORK...
            front_ptr--;
            *front_ptr = entry;
        }
        ...
        {
            //decrement first_bp create a new array assign the entry to the end of the block
            // STUDENT WORK...
            first_bp--;
            *first_bp = new value_type[block_size];
    ...
    void deque<Item>::push_back(const value_type& entry)
    {
        ...
        if (last_bp == NULL)
        {
            ...
            //create a new array and assign appropriate values. Set entry at the end of the array
            // STUDENT WORK...
            *first_bp = new value_type[block_size];
            front_ptr = *first_bp;
            back_ptr = *last_bp;
        ...
        {
            //increment back_ptr and assign entry to it
            // STUDENT WORK...
            back_ptr++;
            *back_ptr = entry;
        ...
        {
            //increment last_bp to and assign a new array to make room for entry which is place in the first spot
            // STUDENT WORK...
            last_bp++;
        ...
        {
            //makes room with reserve expands the block array to another array and reassigns appropriate values.
            // STUDENT WORK...
            reserve();
            last_bp++;
            *last_bp = new value_type[block_size];
    ...
    void deque<Item>::pop_front()
    {
        ...
        {
            // deletes the array and reassigns first bp
            // STUDENT WORK...
            delete[] * first_bp;
            *first_bp = NULL;
            first_bp++;
    ...
    void deque<Item>::pop_back()
    {
        ...
        {
            //deletes the array then re assign last_bp
            // STUDENT WORK...
            delete[] back_ptr;
            *last_bp = NULL;
            last_bp--;
