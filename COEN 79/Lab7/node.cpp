...
namespace coen79_lab7
{
    ...
    //creates a new node with the given values. re links the list to make the new item the tail.
    ...
    //continuously uses list head remove until the list is completely removed
    ...
    //creates a temporary pointer to hold the address of the new head. Reassigns the head pointer. deletes the old head.
